...
function Strona_zarządzania_firmą() {
  ...
  const fetchCompanyDetails = async () => {
    try {
      const response = await axios.post('book-it-back.vercel.app'+'/api/Strona_zarządzania_firmą', { company_id });
  ...
  const handleSaveClick = async () => {
    setIsEditing(false);
    try {
      await axios.put('book-it-back.vercel.app'+'/api/Strona_zarządzania_firmą/update', {
        company_id,
        field: editField,
