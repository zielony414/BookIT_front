...
const Log = () => (
  <div className="flex flex-col bg-white">
    ...
    <main className="flex flex-col self-center px-5 mt-40 w-full max-w-[1027px] max-md:mt-10 max-md:max-w-full">
        ...
        <h2 className="self-center mt-96 text-5xl font-light leading-6 text-black max-md:mt-10 max-md:max-w-full max-md:text-4xl"style={{ marginBottom: "50px", marginTop: "100px" }}>
        ...
        <div className="flex gap-5 self-left mt-14 font-light max-md:flex-wrap max-md:mt-10 max-md:max-w-full" style={{marginLeft: "130px"}}>
          <Input label="Data urodzenia" placeholder="Podaj datę urodzenia" />
        </div>
        <label className="mt-8 text-lg font-light leading-6 text-zinc-800 max-md:max-w-full"style={{marginLeft: "180px"}}>
          Coś o tobie
        </label>
        <div className="justify-center items-start px-4 py-3 mt-1.5 bg-white border border-solid border-zinc-400 text-zinc-400 max-md:pr-5 max-md:max-w-full"style={{borderRadius: '0.5rem', marginLeft: "180px", height: "100px"}}>
          <div className="text-lg font-light leading-6 text-zinc-400 max-md:max-w-full">
          <input
            type="text"
            className="justify-start items-start text-sm bg-white text-zinc-400"
            placeholder={"Powiedz coś o sobie, aby usługodawca mógł cię poznać!"}
            style={{width: '500px'}} 
          />
          </div>
        </div>
        <div className="flex grow gap-10px font-light" style={{height: "30px", marginTop: "20px", marginLeft: "500px", marginRight: "20px" }}>
          <Button>Pomiń</Button>
