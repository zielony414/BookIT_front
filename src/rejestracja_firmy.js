...
const handleSubmit = async () => {
  ...
  try {
      const response = await fetch('https://book-it-back.vercel.app/api/strona_rejestracji_firmy/create', {
          method: 'POST',
          headers: {
...
const handleFinish = () => {
  ...
  const DodajUsluge = () => {
    ...
    const handleAddService = async () => {
      ...
      try {
        const response = await fetch('https://book-it-back.vercel.app/api/strona_rejestracji_firmy/usługa', {
          method: 'POST',
          headers: {
            'Content-Type': 'application/json',
          },
